...
func (o *initPipelineOpts) createPipelineManifest() error {
	...
	for _, env := range o.envConfigs {
        ...
        //TODO: Separate Codebuild Role per Pre/Post deploy stage per SVC amd Env
		stage := manifest.PipelineStage{
            ...
            CodeBuildsServiceRole: "arn:aws:iam::" + env.AccountID + ":role/" + env.App + "-" + env.Name + "-<SVC>-IT-CodeBuildRole",
		}
